...
\usepackage{hyperref}
\hypersetup{hidelinks,backref=true,pagebackref=true,hyperindex=true,colorlinks=false,breaklinks=true,urlcolor= bleu,bookmarks=true,bookmarksopen=false,pdftitle={Title},pdfauthor={Author}}
...
\renewcommand\thesubsection{\arabic{section}.\arabic{subsection}.\arabic{subsubsection}}
